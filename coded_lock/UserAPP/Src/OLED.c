...
void OLED_WriteCommand(uint8_t Command) {
    SOFT_I2C_Start(&OLED_Soft_I2C);
    SOFT_I2C_SendByte(&OLED_Soft_I2C, 0X78);
    SOFT_I2C_ReceiveAckBit(&OLED_Soft_I2C);
    SOFT_I2C_SendByte(&OLED_Soft_I2C, 0X00);
    SOFT_I2C_ReceiveAckBit(&OLED_Soft_I2C);
    SOFT_I2C_SendByte(&OLED_Soft_I2C, Command);
    SOFT_I2C_ReceiveAckBit(&OLED_Soft_I2C);
    SOFT_I2C_Stop(&OLED_Soft_I2C);
}
...
void OLED_WriteData(uint8_t Data) {
    ...
    SOFT_I2C_SendByte(&OLED_Soft_I2C, 0X78);
    SOFT_I2C_ReceiveAckBit(&OLED_Soft_I2C);
    SOFT_I2C_SendByte(&OLED_Soft_I2C, 0X40);
    SOFT_I2C_ReceiveAckBit(&OLED_Soft_I2C);
    SOFT_I2C_SendByte(&OLED_Soft_I2C, Data);
    SOFT_I2C_ReceiveAckBit(&OLED_Soft_I2C);
    SOFT_I2C_Stop(&OLED_Soft_I2C);
}
